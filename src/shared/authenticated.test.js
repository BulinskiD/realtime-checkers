...
describe("Authenticated", () => {
   it('should render component when authenticated is true', () => {
       const component = shallow(<Authenticated authenticated={true} display={<div>Test</div>}/>)
   ...
   it('should redirect to /login when authenticated is false', () => {
      const component = shallow(<Authenticated authenticated={false} display={<div>Test</div>} />);
