...
export const Login = (props) => {
    ...
    return (
        <LoginContainer>
            {ReactDOM.createPortal(<BackgroundContainer url='/images/dark-chess.jpg' />, document.getElementById('root'))}
        <LoginForm onSubmit={e=>handleLogin(e)}>
            {props.user.error && <Alert className="text-center" variant="danger">{props.user.error}</Alert>}
